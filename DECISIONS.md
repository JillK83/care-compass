...
| O9 | ResourcePanel bad-ZIP error state missing Eldercare Locator fallback link | Compass | Resolved 2026-07-01 — inline "Try Eldercare Locator instead" link added to zip-error paragraph in CompassPage.tsx (commit 13a28d0). Merged into main 2026-07-02. |
